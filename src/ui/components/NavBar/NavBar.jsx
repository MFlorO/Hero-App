...
export const Navbar = () => {
    ...
    const onLogout = () => navigate('/login', { replace: true })    //replace sirve para que no se pueda volver hacia atras en la navegacion
        ...
        <nav className="navbar navbar-expand-sm navbar-dark bg-dark p-2">
            ...
            <div className="navbar-collapse collapse w-100 order-3 dual-collapse2 d-flex justify-content-end">
                <ul className="navbar-nav ml-auto">
                    <span className='nav-item nav-link text-primary'>Florencia</span>
